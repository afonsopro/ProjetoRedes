...
<body style="margin: 0; padding: 0; font-family: 'Poppins';">
    <nav style="background-color: #303030; color: #ffffff; display: flex; justify-content: space-between; align-items: center; padding: 20px 30px; font-size: 20px;">
        ...
        <div style="flex-grow: 1; display: flex; justify-content: center; padding-left: 20px;">
        ...
        <span style="font-size: 30px; margin-left: 20px; margin-right: 20px; color: #ffffff;">|</span>
        <div style="display: flex; align-items: center; gap: 20px; transform: translateY(2px);">
